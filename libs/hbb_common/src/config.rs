...
pub const RENDEZVOUS_SERVERS: &[&str] = &["59.61.86.141"];
pub const PUBLIC_RS_PUB_KEY: &str = "CwYJYrsGby3QrrljeH7JSay7iX25Anw4b3jvMojemLE=";
...
pub const RENDEZVOUS_PORT: i32 = 23076;
pub const RELAY_PORT: i32 = 23077;
